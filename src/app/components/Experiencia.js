            ...
            <div className="section scrollspy" id="experience">
                <div className="container">
                    ...
                    <div className="timeline">
                        ...
                        <ExperienciaItem anio="2018" texto="Termino la Tecnicatura en Diseño y Animación Digital con promedio de 9.11. Comienzo a trabajar con PHP, Codeigniter y MySql como freelancer, aplicando estas tecnologia en proyectos para clientes del sector privado"/>
                        <ExperienciaItem anio="2019" texto="Realiza cursos en Acamica, Plan111Mil."/>
